...
export const EmployeeForm = forwardRef(({ onClose }: EmployeeFormProps, ref) => {
  const form = useForm<Employee>({
    resolver: zodResolver(employeeSchema.omit({ id: true, department: true })),
    defaultValues: {
      firstName: "",
      lastName: "",
      phone: "",
      ...
      <Form {...form}>
        <form className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input id={field.name} placeholder="555-555-5555" {...field} />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input id={field.name} placeholder="123 Main St" {...field} />
                </FormControl>
          ...
          <FormItem>
            ...
            <FormMessage>{form.formState.errors.hireDate?.message}</FormMessage>
          </FormItem>
